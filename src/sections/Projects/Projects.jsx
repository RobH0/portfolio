  ...
  return (
    <section id="projects" className={styles.container}>
        ...
        <div className={styles.projectsContainer}>
            ...
            <ProjectCard link="https://github.com/RobH0/StudyBot" preview="https://github.com/RobH0/project-gifs/raw/main/StudyBot-preview.png" title="StudyBot" description="A note-taking assistant written in Python that helps you summarize educational YouTube videos into concise study notes, facilitated by the Gemma2 LLM, which runs locally on the user's machine using Ollama." />
